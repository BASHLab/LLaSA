...
def load_model_config(target, prefix, version
                      , path_bert='llava/model/multimodal_encoder/config/limu_bert.json', path_classifier='llava/model/multimodal_encoder/config/classifier.json'):
...
def load_dataset_stats(dataset, version):
    path = 'llava/model/multimodal_encoder/dataset/data_config.json'
