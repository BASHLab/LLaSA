...
unique_classes_dict = {'standing': 1, 'sitting':3, 'walking':5, 'running':7, 'biking':8}
unique_classes =[]
...
result_f = open("/home/simran/SLU/results/llasa_shl_13b.txt","w")
...
#     d_ = data[idx]
#     d_[:, :3] = d_[:, :3]/9.8
#     np.save('../../SHL/images/shl_image_' + str(idx)+'.npy', d_)
#     # break
for idx in tqdm(range(len(data))):
    # sample_index = random.randint(0, len(data))
    sample_index = idx
    image_file = f"/home/simran/SHL/images/shl_image_{sample_index}.npy"
...
disp.plot()
plt.savefig("/home/simran/SLU/results/13b_shl"+"_cm_new.png")
