...
result_f = open("/hdd/LLM/SLU/results/llasa_shl_new.txt","w")
...
for idx in tqdm(range(len(data))):
    ...
    sample_index = idx
    image_file = f"/hdd/LLM/SHL/images/shl_image_{sample_index}.npy"
...
disp.plot()
plt.savefig("/hdd/LLM/SLU/results/shl"+"_cm_new.png")
