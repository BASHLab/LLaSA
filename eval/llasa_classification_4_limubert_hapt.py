...
unique_classes_dict = {}
unique_classes =[]
with open("/home/simran/hapt/activity_labels.txt") as f:
...
data_file_name = "/home/simran/hapt/data_20Hz_hapt.npy"
label_file_name = "/home/simran/hapt/label_20Hz_hapt.npy"
...
result_f = open("/home/simran/SLU/results/llasa_hapt_13b.txt","w")
...
for idx in tqdm(range(len(data))):
    ...
    sample_index = idx
    image_file = f"/home/simran/hapt/images/hapt_image_{sample_index}.npy"
...
disp.plot()
plt.savefig("/home/simran/SLU/results/13b_hapt"+"_cm.png")
