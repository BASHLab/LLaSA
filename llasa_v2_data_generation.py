...
parser.add_argument(
    '--root_data_dir', type=str, default="/hdd/LLM/limuBERT_data/extracted_data"
)
...
def limubert_sample_to_sensorcaps(summary, accl, gyro):
...
with open(sensorcaps_path,"w") as f:
    ...
    # for sample_index in tqdm(range(100,110)):
